...
| 73. Spec nodes: editor-draggable ECS components | complete | Authoring-component pattern: ComponentSpec base + HealthSpec/WeaponSpec/AISpec nodes dragged under actor views; EcsBoot bakes them into entity components at spawn (instance spec beats definition). Nodes in the dock, tables at runtime; specs hold zero logic. Covered by room-test assertions |
